...
# Connect to Wi-Fi
ssid = "NTU FSD" #ID
password = "" #password of my device
sta = network.WLAN(network.STA_IF)
sta.active(True)
time.sleep(1) #Added 1 sec delay

# added try except to safe connecting
...
s = socket.socket(socket.AF_INET, socket.SOCK_STREAM) #IP4 and TCP using
